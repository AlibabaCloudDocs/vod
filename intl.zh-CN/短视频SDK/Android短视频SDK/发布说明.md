...
com.aliyun.video.android:svideopro:3.8.0 -对应的AliyunSdk-RCE.aar
com.aliyun.video.android:svideopro-armv7a:3.8.0 -对应armeabi-v7a架构的短视频所有so库
com.aliyun.video.android:svideopro-arm64:3.8.0 -对应arm64-v8a架构的短视频所有so库
```
...
-   AliyunIRecorder.setDisplayView\(GLSurfaceView surfaceView\)变更为AliyunIRecorder.setDisplayView\(SurfaceView surfaceView\)，参数GLSurfaceView变更为SurfaceView。
