...
|×|IE9及以上版本|
    ...
    **说明：**
    ...
    -   播放FLV、M3U8视频，PC端支持的浏览器，需要启用[跨域访问](/intl.zh-CN/播放器SDK/Web播放器/更多功能介绍/配置跨域访问.md)。
...
Aliplayer SDK除了直接支持Source播放方式外，还支持通过阿里云视频云服务的video方式播放：视频点播请参见[通过播放凭证播放](/intl.zh-CN/开发指南/音视频播放/通过播放凭证播放.md)。示例如下：
