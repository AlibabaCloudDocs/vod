...
-   您已经在ECS服务端安装MySQL5.7数据库。更多信息，请参见[安装与配置MySQL数据库](/cn.zh-CN/趣视频解决方案/安装与配置MySQL数据库.md)。上线后建议使用RDS服务，更多信息，请参见[RDS服务](https://rds-buy.aliyun.com/nextBuy/rds#/create/rds/mysql)。
