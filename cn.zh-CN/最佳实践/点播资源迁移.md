...
-   准备好访问点播服务使用的Access Key。可以通过以下方式获取：
    ...
    -   [RAM子账号访问](/cn.zh-CN/开发指南/账号和授权/创建RAM用户并授权.md)
...
2.  **编写VOD上传程序**
    ...
    **说明：** 迁移程序编写过程中，需要记录视频上传地址与上传至点播后视频ID之间的关联，方便迁移后视频的整理归类。
    ...
    2.  **使用URL批量拉取上传视频（不推荐）**
         ...
         * 请参见[t1235497.dita\#doc\_api\_vod\_UploadMediaByURL](/cn.zh-CN/服务端API/媒体上传/URL批量拉取上传.md)
         */
