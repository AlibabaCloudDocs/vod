...
-   订阅截图事件
    ...
    截图完成时会触发`snapshoted`事件，并返回截图数。示例如下：
...
-   当H5播放视频时浏览器控制台出现No 'Access-Control-Allow-Origin' header is present on the requested resource.，详情请参见[跨域访问配置](https://help.aliyun.com/document_detail/62950.html?spm=a2c4g.11186623.2.52.1e606fc53hzRt4)。
-   当Flash播放器出现CNAME或资源跨域访问错误时，详情请参见[跨域访问配置](https://help.aliyun.com/document_detail/62950.html?spm=a2c4g.11186623.2.52.1e606fc53hzRt4)。
-   Android系统微信或QQ浏览器上播放视频时，由于腾讯X5浏览器会挟持视频自动全屏播放，详情请参见[如何启用H5的同层播放](https://help.aliyun.com/document_detail/62953.html?spm=a2c4g.11186623.2.54.1a616fc5zJ9Ai1)。
