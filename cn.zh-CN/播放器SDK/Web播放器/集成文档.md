...
|×|IE9及以上版本|
    ...
    **说明：**
    ...
    -   播放flv、m3u8视频，PC端支持的浏览器，需要启用[允许跨域访问](https://help.aliyun.com/document_detail/62950.html?spm=a2c4g.11186623.2.17.595f1c4cG6UJqt)。
    -   PC端chrome浏览器在移动模拟器下，播放m3u8需要安装Native HLS Playback Chrome[Native HLS Playback Chrome](https://chrome.google.com/webstore/detail/native-hls-playback/emnphkkblegpebimobpbekeedfgemhof?hl=zh-CN)插件。
...
-   H5阿里云HLS加密播放，适配情况如下：
    ...
    -   媒体处理请参见[MPS视频加密](https://help.aliyun.com/document_detail/50114.html?spm=a2c4g.11186623.6.640.7cc2354fbFI4nx)。
...
-   音量调节功能\(`getVolumn`和`setVolumn`\)在iOS系统和部分Android系统会失效。
...
-   Flash版本，示例如下：
    ...
    ```
    https://g.alicdn.com/de/prismplayer/2.8.2/aliplayer-flash-min.js
    ```
...
-   媒体处理请参见[视频播放](https://help.aliyun.com/document_detail/53522.html?spm=a2c4g.11186623.2.22.3f571c4c4bzNi1)。
...
-   媒体处理播放的参数说明请参见[视频播放](https://help.aliyun.com/document_detail/53522.html?spm=a2c4g.11186623.2.24.3f571c4c34fxVy)。
-   视频点播更多接口请参见[属性和接口说明](/cn.zh-CN/播放器SDK/Web播放器/属性和接口说明.md)。
