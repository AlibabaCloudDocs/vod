...
|FileName|String|Yes|D:\\\*\*\*\*.mp4|The name of the video mezzanine file.
...
|The error message returned because the specified storage location does not exist. Log on to the [ApsaraVideo VOD console](https://vod.console.aliyun.com/?spm=a2c4g.11186623.2.15.6948257eaZ4m54#/vod/settings/censored). Choose **Configuration Management** \> **Media Management** \> **Storage**. On the Storage page, check the storage location. |
