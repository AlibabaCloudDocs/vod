...
|Region|String|No|cn-shanghai|The region where the transcoded file is stored. If you do not specify this parameter, the data in all regions is returned. You can specify multiple regions. Separate them with commas \(,\). Valid values:
...
|Interval|String|No|day|The time granularity at which the data is queried. Valid values:
 ...
 -   **day**
-   **hour** |
|Storage|String|No|bucket01|The name of the Object Storage Service \(OSS\) bucket. If you do not specify this parameter, the data of all buckets is returned. You can specify multiple buckets. Separate them with commas \(,\). |
|Specification|String|No|Audio|The transcoding specification. If you do not specify this parameter, the data of all transcoding specifications is returned. You can specify multiple transcoding specifications. Separate them with commas \(,\). Valid values:
...
|TranscodeDataItem| | | |
|Data|Array of DataItem| |The statistics on transcoding of each specification. |
|DataItem| | | |
